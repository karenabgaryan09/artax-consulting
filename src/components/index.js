...
export { default as SmallNavbar} from './small-navbar/SmallNavbar.js'
...
export {default as TextareaBtn} from './textarea-btn/TextareaBtn.js'
export {default as SwiperCarousel} from './swiper-carousel/SwiperCarousel.js'
